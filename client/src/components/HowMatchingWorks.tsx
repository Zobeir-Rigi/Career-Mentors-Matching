        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col items-start">
            ...
            <p className="font-sans text-[14px] leading-relaxed text-muted">
              Pick the disciplines you want to grow in, your availability, and
              what you want from mentorship.
            </p>
          </div>
          <div className="flex flex-col items-start">
            <span className="font-display text-[46px] leading-none text-accent-soft font-normal mb-3">
            ...
            <p className="font-sans text-[14px] leading-relaxed text-muted">
              Scored on shared disciplines, availability, and location — never a
              name picked off a long list.
            </p>
          </div>
          <div className="flex flex-col items-start">
            <span className="font-display text-[46px] leading-none text-accent-soft font-normal mb-3">
            ...
            <p className="font-sans text-[14px] leading-relaxed text-muted">
              A short, no-commitment call booked straight into your mentor's
              calendar.
            </p>
          </div>
          <div className="flex flex-col items-start">
            ...
            <p className="font-sans text-[14px] leading-relaxed text-muted">
              You each get seven days to say yes. No reply? The match frees up
