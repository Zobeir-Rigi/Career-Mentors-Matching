 ...
 * - multiple mentees with strong matching scenarios
 * - five waiting-list mentees covering unmatched demo scenarios
...
// The first eight mentors are eligible matcher candidates.
...
const MENTORS = [
  ...
  },
  {
    ...
    email: 'mentor.elena@example.com',
    role: Role.MENTOR,
    linkedinURL: 'https://www.linkedin.com/in/demo-elena-rossi',
    scheduleURL: 'https://calendly.com/demo-elena-rossi/mentoring',
    currentJobTitle: 'Lead Data & AI Engineer',
    capacity: 3,
    region: Region.LONDON,
    openToRemote: true,
    availability: [
    ...
    bio: 'Data and AI engineer helping developers move into analytics, machine learning and production data roles.',
    isAcceptingMentees: true,
    approvalStatus: ApprovalStatus.ACCEPTED,
    disciplines: ['Data & Analytics', 'AI & Machine Learning'],
    skills: ['Technical growth', 'Career advice'],
    industries: ['Technology & Telecoms', 'Education & Training'],
    note: 'Eligible; strong data and AI mentoring scenario.',
  },
  {
    fullName: 'Kwame Mensah',
    email: 'mentor.kwame@example.com',
    role: Role.MENTOR,
    linkedinURL: 'https://www.linkedin.com/in/demo-kwame-mensah',
    scheduleURL: 'https://calendly.com/demo-kwame-mensah/mentoring',
    currentJobTitle: 'Senior Platform Engineer',
    capacity: 3,
    region: Region.NORTH_WEST,
    openToRemote: true,
    availability: [
    ...
    meetingCadence: MeetingCadence.FORTNIGHTLY,
    meetingStructure: MeetingStructure.STRUCTURED,
    bio: 'Platform engineer mentoring developers in cloud infrastructure, DevOps and technical career development.',
    isAcceptingMentees: true,
    approvalStatus: ApprovalStatus.ACCEPTED,
    disciplines: ['DevOps, Cloud & Platform', 'Software Engineering'],
    skills: ['Technical growth', 'Confidence'],
    industries: ['Technology & Telecoms', 'Manufacturing & Industrial'],
    note: 'Eligible; strong cloud and DevOps mentoring scenario.',
  },
  {
    fullName: 'Grace Okafor',
    email: 'mentor.grace@example.com',
    role: Role.MENTOR,
    linkedinURL: 'https://www.linkedin.com/in/demo-grace-okafor',
    scheduleURL: 'https://calendly.com/demo-grace-okafor/mentoring',
    currentJobTitle: 'Engineering Career Coach',
    capacity: 2,
    region: Region.LONDON,
    openToRemote: true,
    availability: [
    ...
    meetingStructure: MeetingStructure.OPEN,
    bio: 'Engineering career coach supporting developers with interviews, CVs, networking and career progression.',
    isAcceptingMentees: true,
    approvalStatus: ApprovalStatus.ACCEPTED,
    disciplines: [
      'Career Development & Interview Prep',
    ...
    skills: ['Interview prep', 'CV', 'Networking'],
    industries: ['Professional & Business Services', 'Technology & Telecoms'],
    note: 'Eligible; strong career-development mentoring scenario.',
  },
  {
    fullName: 'Noor Ahmed',
...
const MENTEES = [
  ...
  {
    fullName: 'Priya Shah',
    email: 'mentee.priya@example.com',
    role: Role.MENTEE,
    linkedinURL: 'https://www.linkedin.com/in/demo-priya-shah',
    currentJobTitle: 'Junior Data Analyst',
    reasonsNote:
      'I want to grow from analytics into stronger data engineering and AI skills.',
    region: Region.LONDON,
    openToRemote: true,
    availability: [
      AvailabilityOption.WEEKDAY_AFTERNOON,
    ...
    meetingCadence: MeetingCadence.FORTNIGHTLY,
    meetingStructure: MeetingStructure.MIX,
    bio: 'Early-career data professional looking for technical and career guidance.',
    disciplines: ['Data & Analytics', 'AI & Machine Learning'],
    skills: ['Technical growth', 'Career advice'],
    industries: ['Technology & Telecoms', 'Education & Training'],
    note: 'Positive matcher scenario; Elena should be an excellent match.',
  },
  {
    fullName: 'Daniel Okoro',
    email: 'mentee.daniel@example.com',
    role: Role.MENTEE,
    linkedinURL: 'https://www.linkedin.com/in/demo-daniel-okoro',
    currentJobTitle: 'Junior Cloud Engineer',
    reasonsNote:
      'I want to deepen my DevOps skills and become more confident working with production systems.',
    region: Region.NORTH_WEST,
    openToRemote: true,
    availability: [
      AvailabilityOption.WEEKDAY_EVENING,
    ...
    meetingCadence: MeetingCadence.FORTNIGHTLY,
    meetingStructure: MeetingStructure.STRUCTURED,
    bio: 'Junior cloud engineer looking for practical platform engineering mentorship.',
    disciplines: ['DevOps, Cloud & Platform', 'Software Engineering'],
    skills: ['Technical growth', 'Confidence'],
    industries: ['Technology & Telecoms', 'Manufacturing & Industrial'],
    note: 'Positive matcher scenario; Kwame should be an excellent match.',
  },
  {
    fullName: 'Leila Hassan',
    email: 'mentee.leila@example.com',
    role: Role.MENTEE,
    linkedinURL: 'https://www.linkedin.com/in/demo-leila-hassan',
    currentJobTitle: 'Graduate Software Developer',
    reasonsNote:
      'I want help preparing for interviews and presenting my experience confidently.',
    region: Region.LONDON,
    openToRemote: true,
    availability: [
      AvailabilityOption.WEEKDAY_AFTERNOON,
    ...
    meetingCadence: MeetingCadence.MONTHLY,
    meetingStructure: MeetingStructure.OPEN,
    bio: 'Graduate developer focused on interview preparation and career progression.',
    disciplines: [
      'Career Development & Interview Prep',
      'Software Engineering',
    ],
    skills: ['Interview prep', 'CV', 'Networking'],
    industries: ['Professional & Business Services', 'Technology & Telecoms'],
    note: 'Positive matcher scenario; Grace should be an excellent match.',
  },
  {
  ...
  {
    fullName: 'Nia Roberts',
    email: 'mentee.waiting.qa@example.com',
    role: Role.MENTEE,
    linkedinURL: 'https://www.linkedin.com/in/demo-nia-roberts',
    currentJobTitle: 'Junior QA Analyst',
    reasonsNote:
      'I want guidance developing a long-term career in software quality and testing.',
    region: Region.SHEFFIELD,
    openToRemote: false,
    availability: [AvailabilityOption.WEEKEND_EVENING],
    meetingCadence: MeetingCadence.WEEKLY,
    meetingStructure: MeetingStructure.STRUCTURED,
    bio: 'Junior QA analyst looking for specialised testing mentorship.',
    disciplines: ['QA & Testing'],
    skills: ['Job search'],
    industries: ['Public Sector & Non-Profit'],
    waitingStatus: WaitingStatus.WAITING,
    note: 'Waiting-list scenario; current approved mentors should remain below threshold.',
  },
  {
    fullName: 'Omar Ali',
    email: 'mentee.waiting.ba@example.com',
    role: Role.MENTEE,
    linkedinURL: 'https://www.linkedin.com/in/demo-omar-ali',
    currentJobTitle: 'Junior Business Analyst',
    reasonsNote:
      'I want mentorship focused on business analysis in public-sector organisations.',
    region: Region.SHEFFIELD,
    openToRemote: false,
    availability: [AvailabilityOption.WEEKEND_EVENING],
    meetingCadence: MeetingCadence.WEEKLY,
    meetingStructure: MeetingStructure.STRUCTURED,
    bio: 'Business analyst seeking specialised guidance and career development.',
  ...
  {
    fullName: 'Zoe Carter',
    email: 'mentee.waiting.ux@example.com',
    role: Role.MENTEE,
    linkedinURL: 'https://www.linkedin.com/in/demo-zoe-carter',
    currentJobTitle: 'Junior UX Designer',
    reasonsNote:
      'I want support developing my UX career and moving into professional product design work.',
    region: Region.WEST_MIDLANDS,
    openToRemote: true,
    availability: [AvailabilityOption.WEEKDAY_AFTERNOON],
    meetingCadence: MeetingCadence.MONTHLY,
    meetingStructure: MeetingStructure.MIX,
    bio: 'Junior designer looking for UX career and portfolio guidance.',
    disciplines: ['UX & Design'],
    skills: ['Career transition', 'CV'],
    industries: ['Professional & Business Services'],
    waitingStatus: WaitingStatus.WAITING,
    note: 'Waiting-list scenario; Imani would become a strong match if approved.',
  },
  {
...
async function main() {
  ...
  console.log(
    '3. Login as admin.demo@example.com: Casey/Maya/Nia/Omar/Zoe should populate waiting-list states, and Noor/Imani should be pending mentor approvals.',
  );
  console.log(
